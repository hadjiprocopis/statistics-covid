package Statistics::Covid::Schema::Result::WorldbankData;
...
print __PACKAGE__ . ": preparing table ".$Statistics::Covid::WorldbankData::Table::SCHEMA->{'tablename'}."\n";

if( ! __PACKAGE__->table($Statistics::Covid::WorldbankData::Table::SCHEMA->{'tablename'}) ){ die "call to table() has failed for table name '".$Statistics::Covid::WorldbankData::Table::SCHEMA->{'tablename'}."'." }
my $sc = $Statistics::Covid::WorldbankData::Table::SCHEMA->{'schema'};
die "there is no schema!" unless defined $sc;

for my $acolname (@{$Statistics::Covid::WorldbankData::Table::SCHEMA->{'column-names'}}) {
...
if( ! __PACKAGE__->set_primary_key(@{$Statistics::Covid::WorldbankData::Table::SCHEMA->{'column-names-for-primary-key'}}) ){ die "call to set_primary_key() has failed for: ".join(',',@{$Statistics::Covid::WorldbankData::Table::SCHEMA->{'column-names-for-primary-key'}})."." }
...
Statistics::Covid::Schema::Result::WorldbankData - Version is a table in our database of collected Covid statistics and this module initialises this table using DBIx::Class
...
primary key columns, etc., stored in L<Statistics::Covid::WorldbankData::Table>.
...
the new table, by copying L<Statistics::Covid::WorldbankData::Table>
and modifying it.
...
which you will see its format in L<Statistics::Covid::WorldbankData::Table>,
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Statistics::Covid::Schema::Result::WorldbankData
