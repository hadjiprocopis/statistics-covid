...
# Optionally, set 'has-header-at-this-line' to true if the
# first line contains the header.
# Other options:
#  'Text::CSV_XS-params-new' passes a hashref of params to
# the constructor of Text::CSV_XS
# a default of 'auto_diag=>1' is already set (but can be
# overwritten by setting its opposite).
# useful param to be passed onto Text::CSV_XS-params-new are
#   'blank_is_undef' =>1,
#   'sep_char' => ",",
#   'quote_char' => '"',
#
#  'Text::CSV_XS-params-header' passes a hashref of params to Text::CSV_XS::header()
# (considered only when has-header-at-this-line is true)
# useful is:
#   'munge_column_names' => 'none' (which stops it from lowercasing all column names!)
#    
# On failure it returns undef
# On success:
# If 'has-header-at-this-line' is true, it returns an arrayref
...
# If 'has-header-at-this-line' is false, it returns an arrayref
