...
ok(1==1, "db name: '$dbfullpath'."); $num_tests++;
...
ok($ret->{'num-replaced'}==4, "num-replaced checked (".$ret->{'num-replaced'}.")"); $num_tests++;
...
ok($ret->{'num-total-records'}==10, "num-total-records checked (".$ret->{'num-total-records'}.")"); $num_tests++;
ok($ret->{'num-not-replaced-because-better-exists'}==5, "num-not-replaced-because-better-exists checked (".$ret->{'num-not-replaced-because-better-exists'}.")"); $num_tests++;
ok($ret->{'num-virgin'}==1, "num-virgin checked (".$ret->{'num-virgin'}.")"); $num_tests++;
$count = $io->db_count();
...
ok($ret->{'num-not-replaced-because-ignore-was-set'}==0, "num-not-replaced-because-ignore-was-set checked (".$ret->{'num-not-replaced-because-ignore-was-set'}.")"); $num_tests++;
ok($ret->{'num-total-records'}==$num_objs_to_insert, "num-total-records checked (".$ret->{'num-total-records'}.")"); $num_tests++;
ok($ret->{'num-not-replaced-because-better-exists'}==0, "num-not-replaced-because-better-exists checked (".$ret->{'num-not-replaced-because-better-exists'}.")"); $num_tests++;
ok($ret->{'num-virgin'}==$num_objs_to_insert, "num-virgin checked (".$ret->{'num-virgin'}.")"); $num_tests++;
$count = $io->db_count();
