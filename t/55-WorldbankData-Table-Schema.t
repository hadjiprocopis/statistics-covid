...
my ($ret, $schema, $wbobj, $dbspecificparams, $c2f);
...
$wbobj = Statistics::Covid::WorldbankData->make_random_object();
ok(defined($wbobj), 'Statistics::Covid::WorldbankData->make_random_object()'." called."); $num_tests++;

$dbspecificparams = $wbobj->_dbspecific;
ok(defined($dbspecificparams), "dbspecificparams() called."); $num_tests++;

$schema = $wbobj->_dbspecific->{'schema'};
